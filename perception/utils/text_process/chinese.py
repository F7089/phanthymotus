...
from .text.canton_normalization.text_normlization import TextNormalizer
...
pinyin_to_symbol_map = {
    ...
    for line in open(os.path.join(current_file_path, "text", "opencpop-strict.txt")).readlines()
}
...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(
        ...
        model_source=os.environ.get("bert_path", "/mnt/GPT_SoVITS/lj1995/GPT-SoVITS/chinese-roberta-wwm-ext-large"),
        v_to_u=False,
