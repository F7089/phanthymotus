...
class TextNormalizer:
    ...
    def _post_replace(self, sentence: str) -> str:
        ...
        sentence = sentence.replace("±", "正负")
        sentence = sentence.replace("III.", "三")
        sentence = sentence.replace("II.", "二")
        sentence = sentence.replace("I.", "一")
    ...
    def normalize_sentence(self, sentence: str) -> str:
        ...
        sentence = RE_SIMPLE_RATIO.sub(lambda m: m.group(0).replace(":", "比").replace("：", "比"), sentence)
